...
- `README.md`:
  - **“DGS Engenharia & Arquitetura”**
  - também usa a marca **“SE LIGA NA REDE”**
- `VERIFICACAO_PLATAFORMA.md`:
  - **“FCN Construcoes e Saneamento”**
  - e ainda impõe em “Regras invioláveis”:
    - **“Empresa: FCN Construcoes e Saneamento (NUNCA ‘DGS Engenharia’)”**
- `MANUAL_DEFINITIVO_PLATAFORMA.md`:
  - **“FCN Construcoes e Saneamento”**
  - repete a regra de nunca usar DGS
- `COMO_ABRIR.md`:
  - **“FCN Construções”**
...
- Em um ponto aparece **empresa** como `DGS Engenharia & Arquitetura`.
...
- Não fica claro se:
  ...
  - DGS = empresa anterior/incorreta;
...
2. **Empresa conflita**:
   - `README.md` usa **DGS Engenharia & Arquitetura**
   - `VERIFICACAO_PLATAFORMA.md` e `MANUAL_DEFINITIVO_PLATAFORMA.md` dizem que a empresa correta é **FCN Construções e Saneamento** e que DGS nunca deve ser usada
