...
linhas_capa = [
    ...
    (6,  "GERÊNCIA:",    "FCN Construções e Saneamento — Felipe Nery"),
...
PROCESSOS = [
    ...
    ("PRÉ-OBRA","Projeto executivo (traçado rede)","6 sem antes","5-10 dias","FCN Construções e Saneamento","NÃO — antes da obra","Define diâmetros, profundidades, PVs"),
    ...
    ("PRÉ-OBRA","Cadastro Comercial (SABESP)","2 sem antes","1-2 semanas","SABESP + FCN","SIM — durante obra","Identificar imóveis sem hidrômetro"),
    ("PRÉ-OBRA","Sondagem geológica (DIFIC 4-5)","4 sem antes","3-5 dias","Sondagem","NÃO — antes escavação","Apenas em núcleos com DIFIC≥4"),
    ("PRÉ-OBRA","Montagem pátio/canteiro","1 sem antes","2-3 dias","Mestre de obras","NÃO — antes início","Almoxarifado, vestiário, sanitário portátil"),
    ...
    ("REDE ÁGUA","Lavagem e desinfecção rede (SABESP)","AGENDAR 2 DIAS ANTES","2-3h/trecho","SABESP + FCN","NÃO — antes ligações","⚠ CRÍTICO: agendar com antecedência"),
    ...
    ("CADASTRO PÓS-OBRA","Levantamento as-built ligações","—contínuo","durante exec.","Topógrafo/FCN","SIM","Coordenadas GPS cada lig."),
    ("CADASTRO PÓS-OBRA","Ficha de ligação (LA/LE) SABESP","—após lig.","30min/lig","FCN","SIM","Formulário eletrônico SABESP"),
    ("CADASTRO PÓS-OBRA","Boletim de medição","mensal","2 dias","FCN Construções e Saneamento","NÃO","Enviar até dia 20 de cada mês"),
    ("CADASTRO PÓS-OBRA","GRD (Guia de Recebimento Definitivo)","após encerrar núcleo","5-10 dias","FCN + SABESP","NÃO","Necessário para encerramento"),
    ("CADASTRO PÓS-OBRA","Entrega documentação técnica","após GRD","1-2 dias","FCN","NÃO","Plantas, fichas, fotos"),
]
