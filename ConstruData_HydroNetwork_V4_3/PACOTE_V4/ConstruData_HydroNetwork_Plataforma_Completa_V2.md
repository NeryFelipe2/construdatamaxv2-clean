...
> ⛔ **REGRA ABSOLUTA:** NUNCA usar "FCN Construções e Saneamento" em NENHUM arquivo, output, variável, comentário ou interface.
...
1. Empresa: **FCN Construções e Saneamento** (NUNCA "FCN Construções e Saneamento")
