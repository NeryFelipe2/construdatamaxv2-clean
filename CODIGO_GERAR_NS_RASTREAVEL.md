# 📝 SCRIPT gerar_ns_rastreavel.py

## INSTRUÇÕES:

1. Copie TODO o código abaixo
2. Crie um novo arquivo: `C:\Users\felip\Downloads\NOVA NS Versao 5\gerar_ns_rastreavel.py`
3. Cole o código
4. Execute: `python gerar_ns_rastreavel.py --batch`
...
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."  # Substituir pela key real
...
1. **Copiar código acima** para `C:\Users\felip\Downloads\NOVA NS Versao 5\gerar_ns_rastreavel.py`
2. **Executar SQL no Supabase** (ver arquivo RESUMO_SISTEMA_NS_V5.md)
3. **Testar:** `python gerar_ns_rastreavel.py --batch`
4. **Verificar saída** em `SAIDA_NS_V5/`
5. **Confirmar dados no Supabase**
