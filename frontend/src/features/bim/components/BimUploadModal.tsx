...
export function BimUploadModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-xl w-full max-w-lg p-5 shadow-2xl">
        {/* Header */}
        ...
        {tab === 'dxf' && (
          <>
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-3 mb-3 space-y-1.5">
              <p className="text-gray-300 text-xs font-semibold">Como exportar do AutoCAD:</p>
              <p className="text-gray-400 text-[11px]">
                No AutoCAD: <span className="font-mono text-gray-300">Arquivo → Salvar Como → AutoCAD DXF (*.dxf)</span>
              </p>
              <p className="text-gray-500 text-[10px]">Suporte: DXF R12 a 2024 · LINE, LWPOLYLINE, POLYLINE, CIRCLE, ARC, SPLINE, 3DFACE</p>
              <p className="text-gray-500 text-[10px]">Layers são mapeados automaticamente → tubo, laje, pilar, parede, viga</p>
            ...
            <div
              ...
              className={cn(
                ...
                dxfDragging ? 'border-indigo-500 bg-indigo-500/10' : 'border-gray-700 hover:border-gray-500',
              )}
            >
              <Layers size={28} className="mx-auto text-gray-500 mb-2" />
              {dxfFile ? (
                <>
                ...
                <>
                  <p className="text-gray-300 text-sm font-medium">Arraste o arquivo .DXF aqui</p>
