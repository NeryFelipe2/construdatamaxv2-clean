  ...
  return (
    <div className="flex gap-4 h-full">
      ...
      <div className="flex flex-col flex-1 min-w-0 gap-4">
        {/* Table */}
        <div className="flex-1 bg-[#2c2c2c] border border-[#525252] rounded-xl overflow-hidden flex flex-col">
          <div className="px-4 py-3 border-b border-[#525252] flex items-center justify-between gap-3">
          ...
          <div className="flex-1 overflow-auto overflow-x-auto">
            {lines.length === 0 ? (
              ...
              <table className="w-full text-xs border-collapse">
                ...
                {lines.length > 0 && (
                  <tfoot>
                    <tr className="border-t-2 border-[#f97316]/30 bg-[#484848]">
        ...
        <div className="grid grid-cols-4 gap-3 shrink-0">
          {[
            ...
            <div
              key={label}
              className={cn(
                'bg-[#2c2c2c] border rounded-xl p-4 flex flex-col gap-1',
                accent ? 'border-[#f97316]/40' : 'border-[#525252]',
              )}
            >
      ...
      <div className="w-72 shrink-0">
        <div className="bg-[#2c2c2c] border border-[#525252] rounded-xl p-4 flex flex-col gap-4">
              ...
              <div key={key} className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-[#333333] border border-[#1f3c5e] rounded px-3 py-1.5 text-[#f5f5f5] text-sm focus:outline-none focus:border-[#f97316] tabular-nums"
                  />
