...
# Cartografias DXF por núcleo (SUPERIOR ao GPKG para nomes de rua!)
CARTOGRAFIAS_DXF = {
    "Pantanal Baixo":   "MAPA PANTANAL BAIXO_R04 (QGIS).dxf",
    "Vila Criadores":   "CARTOGRAFIA VILA CRIADORES_R06 (QGIS).dxf",
    "Vila Israel":      "MAPA PANTANAL ALTO (VILA ISRAEL)_RV02 (QGIS).dxf",
    "Morro do Teteu":   "MAPA TETEU-VALE VERDE_R04 (QGIS).dxf",
    "Sao Manoel":       "MAPA SÃO MANOEL_RV05 (QGIS).dxf",
    "Joao Carlos":      "MAPA JOÃO CARLOS DA SILVA_RV07 (QGIS).dxf",
    "Vale Verde":       "MAPA TETEU-VALE VERDE_R04 (QGIS).dxf",
}
