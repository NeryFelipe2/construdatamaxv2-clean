...
//        â†’ MontarTarefa
//          â†’ InsertSupabase
//            â†’ ConfirmarDelegante
//              â†’ ResponseOk
//          â†’ TemTelResp
//            â†’ NotificarResponsavel
// </workflow-map>
...
export class ConstrudataTarefaWhatsappWorkflow {
    ...
    ConfirmarDelegante = {
        ...
        specifyBody: 'json',
        jsonBody:
            '={"number":"{{ $node[\'Montar Tarefa\'].json.delegantePhone }}","textMessage":{"text":"âœ… *Tarefa criada!*\\n\\nðŸ“‹ {{ $node[\'Montar Tarefa\'].json.descricao }}\\nðŸ‘¤ ResponsÃ¡vel: {{ $node[\'Montar Tarefa\'].json.responsavel }}\\nðŸ”´ Status: pendente"}}',
        options: {},
    };
