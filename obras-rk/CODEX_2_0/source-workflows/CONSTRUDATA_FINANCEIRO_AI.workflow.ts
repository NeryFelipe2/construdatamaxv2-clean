...
export class ConstrudataFinanceiroAiWorkflow {
    ...
    GeminiOcr = {
        ...
        specifyBody: 'json',
        jsonBody:
            '={{ JSON.stringify({contents:[{parts:[{text:\'Analise esta imagem de comprovante fiscal e extraia um JSON com estes campos exatos:\\n{\\n  "valor": (number, valor total em reais),\\n  "data": "YYYY-MM-DD",\\n  "fornecedor": "nome do estabelecimento",\\n  "cnpj_cpf": "CNPJ ou CPF do fornecedor se visÃ­vel",\\n  "descricao": "descriÃ§Ã£o dos itens/serviÃ§os",\\n  "forma_pagamento": "PIX|CartÃ£o|Dinheiro|Boleto|TransferÃªncia",\\n  "plano_conta": "MAT|MDO|DSL|ALM|AEQ|OUT",\\n  "plano_conta_desc": "Material de ConstruÃ§Ã£o|MÃ£o de Obra|Diesel / CombustÃ­vel|AlimentaÃ§Ã£o|Aluguel de Equipamento|Outros"\\n}\\n\\nCÃ³digos de plano_conta:\\nMAT = Material de ConstruÃ§Ã£o\\nMDO = MÃ£o de Obra\\nDSL = Diesel / CombustÃ­vel\\nALM = AlimentaÃ§Ã£o / VR / VA\\nAEQ = Aluguel de Equipamento\\nOUT = Outros\\n\\nRetorne APENAS o JSON, sem markdown.\'},{inline_data:{mime_type:\'image/jpeg\',data:$json.base64}}]}]}) }}',
        options: {},
    };
